        ...
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <div className="max-w-md w-full p-8 bg-card text-card-foreground rounded-lg shadow-md border border-border">
                    ...
                    <button
                        type="button"
                        onClick={() => import("next-auth/react").then(({ signIn }) => signIn("google", { callbackUrl: "/dashboard" }))}
                        className="w-full flex items-center justify-center gap-2 border border-input bg-background p-3 rounded hover:bg-accent hover:text-accent-foreground transition-colors font-medium"
                    >
